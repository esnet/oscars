...
import gen.saml.assertion.ObjectFactory;
...
@XmlSeeAlso({gen.nsi_2_0.framework.types.ObjectFactory.class, ObjectFactory.class, gen.xmlenc.ObjectFactory.class, gen.xmldsig.ObjectFactory.class, gen.nsi_2_0.connection.types.ObjectFactory.class, gen.nsi_2_0.framework.headers.ObjectFactory.class})
...
public interface ConnectionRequesterPort {
    ...
    public GenericAcknowledgmentType reserveFailed(
        ...
        javax.xml.ws.Holder<CommonHeaderType> header
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType querySummaryConfirmed(
        ...
        QuerySummaryConfirmedType querySummaryConfirmed,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws ServiceException;
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType provisionConfirmed(
        ...
        GenericConfirmedType provisionConfirmed,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws ServiceException;
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType error(
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType releaseConfirmed(
        ...
        GenericConfirmedType releaseConfirmed,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws ServiceException;
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType errorEvent(
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType reserveAbortConfirmed(
        ...
        GenericConfirmedType reserveAbortConfirmed,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws ServiceException;
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType reserveCommitFailed(
        ...
        GenericFailedType reserveCommitFailed,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws ServiceException;
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType reserveCommitConfirmed(
        ...
        GenericConfirmedType reserveCommitConfirmed,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws ServiceException;
