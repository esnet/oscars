...
public interface ConnectionProviderPort {
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType queryNotification(
        ...
        QueryNotificationType queryNotification,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws ServiceException;
    ...
    public ReserveResponseType reserve(
    ...
    @WebResult(name = "acknowledgment", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/connection/types", partName = "acknowledgment")
    public GenericAcknowledgmentType queryResult(
    ...
    public QueryNotificationConfirmedType queryNotificationSync(
        ...
        QueryNotificationType queryNotificationSync,
        @WebParam(partName = "header", mode = WebParam.Mode.INOUT, name = "nsiHeader", targetNamespace = "http://schemas.ogf.org/nsi/2013/12/framework/headers", header = true)
        javax.xml.ws.Holder<CommonHeaderType> header
    ) throws Error;
}
